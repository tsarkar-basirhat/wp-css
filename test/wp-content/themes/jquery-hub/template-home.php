...
<section class="stayInformed">
	<div class="container">
		<div class="stayInformed-main">
      <h2>STAY INFORMED</h2>
		</div>
	</div>
</section>
...
<section class="editorsPick">
	<div class="container">
    <h3><span>Editor’s Picks</span></h3>
		<?php query_posts($args = array('post_type' => 'post', 'posts_per_page' => 8 )); ?>
		<ul class="clearfix">
			<?php while (have_posts()) : the_post(); ?>
				<li>
					<div class="editorsPickSingle">
						<div class="row">
							<div class="col-lg-4">
								<div class="editorImg"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/slide.jpg" alt=""></div>
							</div>
							<div class="col-lg-8">
								<div class="editorTxt">
									<h2><?php the_title(); ?></h2>
